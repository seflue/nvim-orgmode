...
function Capture:_setup_capture_write(capture_window)
  vim.api.nvim_create_autocmd('BufWriteCmd', {
    ...
    -- The refile opens the destination in a buffer and writes it. Without
    -- nested, the BufAdd/BufWrite autocmds for that buffer stay silent, and the
    -- buffer cache keeps reporting the destination as having no buffer.
    nested = true,
    callback = function()
