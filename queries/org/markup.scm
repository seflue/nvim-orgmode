(paragraph [
 ...
 ((expr "[" "[") @hyperlink.start (_)+ (expr "]" "]") @hyperlink.end (#org-is-valid-hyperlink-range? @hyperlink.start @hyperlink.end))
 (expr "[" @hyperlink_node.start "[" _ "]" "]" @hyperlink_node.end (#org-is-valid-hyperlink-node? @hyperlink_node.start @hyperlink_node.end))
